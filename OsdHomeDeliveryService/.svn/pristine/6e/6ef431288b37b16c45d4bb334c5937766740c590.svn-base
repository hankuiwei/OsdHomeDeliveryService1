 ...
 */
public class PackingListAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public PackingListAdapter(Context mContext, List<ChangeBoxTypeData> list) {
