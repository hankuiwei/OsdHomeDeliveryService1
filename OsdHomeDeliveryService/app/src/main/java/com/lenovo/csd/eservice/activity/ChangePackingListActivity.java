...
public class ChangePackingListActivity extends BaseActivity {
    ...
    private PackingListAdapter mPackingAdapter2;
    ...
    protected void initView() {
        ...
        mPackingAdapter2 = new PackingListAdapter(ChangePackingListActivity.this, datas);
    ...
    protected void setClickLintenner() {
       ...
       /* mPacksearchOCode.setOnClickListener(new View.OnClickListener() {
        ...
        mPackingAdapter2.setOnItemClickListener(new PackingListAdapter.OnRecyclerViewItemClickListener() {
            @Override
        ...
        mPackingAdapter2.setOnHisClickListener(new PackingListAdapter.OnRecyclerViewHisClickListener(){
            @Override
        ...
        mPackingAdapter2.setOnBareClickListener(new PackingListAdapter.OnRecyclerViewBareClickListener(){
            @Override
